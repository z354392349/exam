data.wlyl = [
  ...
  {
    title:
      "虚电路网络如何建立虚电路？虚电路网络分组转发的依据是什么？ / 第四章",
    simple: "",
    normal: [
      "建立虚电路：",
  ...
  {
    title:
      "假设 IEEE 802.11 的 RTS 帧和 CTS 帧与标准的 DATA 帧和 ACK 一样长，使用 RTS 帧和 CTS 帧会有好处吗？为什么？  / 第七章",
    simple: "",
    normal: [
  ...
  },
  {
    ...
    normal: [
      ...
      "2.消息完整性：发送方与接收方能够与发送方相互篡改，发生篡改一定会被检测到。",
      "3.可访问与可用性：可访问与可用性是网络信息可被授权实体访问并按需求使用的特性。",
  ...
  {
    title:
      "分析密码散列函数的功能，比较不同类型密码散列函数的输入、输出特性。/ 第八章",
    simple: "",
    normal: [
      "功能：实现消息完整性检测",
      "方法：利用密码散列函数检验（MD5、SHA-1）",
