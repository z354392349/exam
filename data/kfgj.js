data.kfgj = [
  ...
  {
    title: "简述软件开发过程中各类人员与计算机之间流通信息的内容  / 第三章",
    simple: "",
    normal: [
  ...
  },
  {
    ...
    normal: [
      ...
      "其基本思想是把信息流看做一个组织或系统运作的线索，简明扼要地描述处理的过程。数据流程图不仅应用于描述已有系统的状况，也应用于描述设想中新系统的状况。",
    ],
    start: 1,
  },
  {
    title: "试述软件开发工具中信息库(Repository)包含的主要内容  / 第三章",
    simple: "",
    normal: [
      "1.有关软件应用的领域与环境的状况；",
      "1.需求分析阶段中收集的有关用户的信息；",
  ...
  },
  {
    ...
    simple: "",
    normal: [
      "软件开发工具的标准化是指软件构件的标准化以及用标准构件组成大型软件结构的标准化",
      "",
      "",
    ],
    start: 1,
  ...
  {
    title: "计算机网络的普遍使用对软件开发工具有什么影响？ / 第六章",
    simple: "",
    normal: [
      "通过将网络引入软件开发工具,软件开发人员可以更方便地互通信息,共享知识, ",
      "更便于掌握项目的进展情况、质量状况等，这就给软件重用、知识重用提供了新的机会，也提高了工作放率。",
    ],
    start: 1,
  },
  {
  ...
  {
    title:
      "针对软件开发过程的各个工作阶段，软件开发工具应在哪些方面提供帮助和支持？ /  历年真题",
    simple: "",
    normal: [
      "认识与描述客观系统",
      "存储及管理开发过程中的信息",
  ...
  {
    title: "简述即插即用程序设计的基本思想 /  历年真题",
    simple: "",
    normal: [
      "是在面向对象的程序设计方法的基础上提出来的。在硬件的制造中，芯片的制造与整机的制造是分开进行的。一",
      "一部分人专门生产软件组件（相当于芯片），而另一部分人构造整个软件的结构（相当于计算机结构），",
      "且把软件组件插入这个结构，以便迅速地完成大型软件的研制工作。",
    ],
    start: 1,
  },
  {
  ...
  {
    title: "软件开发过程中涉及哪几类信息，各有什么作用？ /  历年真题",
    simple: "",
    normal: [
  ...
  {
    title: "从发展趋势来看，软件开发工具领域有哪些值得关注的方向？/  历年真题",
    simple: "",
